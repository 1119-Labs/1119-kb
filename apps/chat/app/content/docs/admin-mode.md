...
Savoir uses [`@evlog/nuxthub`](https://github.com/HugoRCD/evlog) for structured logging. Every API request, bot interaction, and workflow execution is automatically logged to the `evlog_events` table in your [NuxtHub](https://hub.nuxt.com) database.
